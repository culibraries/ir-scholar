...
module Hyrax
  class ConferenceProceedingPresenter < Hyrax::WorkShowPresenter
    ...
    delegate :title, :abstract, :academic_affiliation, :additional_information, :alternative_title, :bibliographic_citation, :conference_location, :conference_name, :event_date,
