...
module Hyrax
  class ConferenceProceedingPresenter < Hyrax::BasePresenter
    delegate :title,:abstract,:academic_affiliation,:additional_information,:alt_title,:bibliographic_citation,:conference_location,:conference_name,:event_date,
