  ...
  module Collections
    class PermissionsService
      ...
      def self.can_view_admin_show_for_collection?(collection_id:, ability:)
        ...
        manage = manage_access_to_collection?(collection_id: collection_id, ability: ability)
        Hyrax.logger.warn("User has ability to manage collection: #{manage ? 'true' : 'false'}")
        deposit = deposit_access_to_collection?(collection_id: collection_id, ability: ability, exclude_groups: exclude_groups)
        Hyrax.logger.warn("User has ability to deposit into collection: #{deposit ? 'true' : 'false'}")
        view = view_access_to_collection?(collection_id: collection_id, ability: ability, exclude_groups: exclude_groups)
        Hyrax.logger.warn("User has ability to view collection: #{view ? 'true' : 'false'}")
        manage_access_to_collection?(collection_id: collection_id, ability: ability) ||
