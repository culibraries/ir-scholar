...
## CUBL change:
# Copy this service from Hyrax 5.x to override the 3.x version we use for compatibility between the current ActiveFedora
# models we use and the agnostic code introduced with Valkyrie (the agnostic layers don't work at the moment for us in
# Hyrax 3.x)
module Hyrax
  ##
