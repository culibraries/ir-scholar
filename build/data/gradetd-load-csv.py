...
csvfile.close()
api_url = 'https://libapps.colorado.edu/api/catalog/data/catalog/cuscholar-final-2019-12-20.json?query={"filter":{"samvera_url":{"$exists":false},"document_type":"dissertation"}}'
