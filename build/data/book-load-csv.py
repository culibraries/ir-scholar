...
# book
#api_url = 'https://libapps.colorado.edu/api/catalog/data/catalog/cuscholar-final.json?query={"filter":{"document_type":"book"}}&page_size=0'
# Book Chapter
api_url = 'https://libapps.colorado.edu/api/catalog/data/catalog/cuscholar-final.json?query={"filter":{"document_type":"book_chapter"}}&page_size=0'
...
csv_headers = ['title', 'date created', 'resource type', 'creator', 'contributor', 'keyword', 'license', 'rights statement', 'publisher',
               ...
               'isbn', 'editor', 'in_series', 'additional_information', 'alt_title',  'date_available', 'date_issued',
...
def transform(itm):
    ...
    data_row['additional_information'] = clean_abstract_text(itm['comments'])
