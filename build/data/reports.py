...
csvfile.close()
# P
api_url = 'https://libapps.colorado.edu/api/catalog/data/catalog/cuscholar-final.json?query={"filter":{"document_type":{"$in":["technical_report","working_paper"]}}}&page_size=0'
